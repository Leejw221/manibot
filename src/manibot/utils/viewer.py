...
주는데(왼쪽 65361) 하위 바이트만 취하면 65361 & 255 = 81 = 'Q' 가 되어 **왼쪽 화살표가
종료 명령이 된다** (2026-09-08 실측). 위/오른쪽도 'R'/'S' 로 둔갑한다. 그래서 전체 코드를
그대로 보고 표로 푼다. 빌드마다 방향키 코드가 달라 세 계열을 모두 넣는다. 우리 문자 명령
(i/n/r/s/q = 105/110/114/115/113)은 81~84 와 겹치지 않으므로 그 구간은 안전하다.
"""
