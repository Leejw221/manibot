...
class Nero(ManipulatorModel):
    ...
    @property
    def init_qpos(self):
        """작업 준비 자세 — 손이 작업대 위 각 팔의 여유 큰 자리에, 그리퍼는 아래를 향한다.
        ...
        **원점 자세도 조립 자세도 아니다.** 셋을 구분한다:
        ...
        그대로 제어 여유가 된다. 손 목표 (base+0.36, ±0.33, 작업대+0.20) 에 대해 IK 300 시드로
        여유가 가장 큰 해를 골랐다 — 21.7° [2026-09-06].
        """
        right = np.radians([-60.8, -78.0, 82.4, 96.9, -12.9, -5.9, 20.8])
